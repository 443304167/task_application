...
void addTask(
  ...
  String groupKey,
  DateTime date,
  String priority, // الأولوية الجديدة
  String focusLevel, // مستوى التركيز الجديد
) {
  final newUserTask = UserTask(
    date.toString(),
    title,
    ...
    startingDate,
    imagePath: _taskGroup[groupKey]!,
    priority: priority, // تعيين القيمة الجديدة
    focusLevel: focusLevel, // تعيين القيمة الجديدة
  );
  ...
  DBHelper.insert('USERTASK', {
    ...
    'stDate': newUserTask.startingDate != null
        ...
        : '',
    'image': newUserTask.imagePath,
    'priority': newUserTask.priority, // تخزين الأولوية
    'focusLevel': newUserTask.focusLevel, // تخزين مستوى التركيز
    'isDone': 0,
  });
}
  ...
  _userTaskList = dataList
      .map(
        (item) => UserTask(
          ...
          priority: item['priority'], // استرجاع الأولوية
          focusLevel: item['focusLevel'], // استرجاع مستوى التركيز
